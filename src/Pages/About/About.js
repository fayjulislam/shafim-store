...
import './About.css';
import about from '../../Images/apple-group-2.png';
                    ...
                    <Row>
                        <Col xs={12} md={6} lg={5}>
                            <div className="img-box">
                                <img className="about-img pt-5" src={about} alt="" />
                            </div>
                        </Col>
                        <Col xs={12} md={6} lg={7}>
                            <div className="detail-box">
                                ...
                                <p>
                                    Welcome to ShafimStore! We are the online watch store that you have been looking for. Our goal and mission here at ShafimStore is to help you find and own the perfect luxury watch. Have you been thinking of purchasing a Rolex, Omega, Tag Heuer or Seiko?
                                </p>
                                <p>
