...
const Login = () => {
    ...
    return (
        <>
            ...
            >
                <h1 className="mt-5 text-danger">LOG IN</h1>
                <Container>
                    <Row className="justify-content-center mt-5">
                        <Col xs={10} md={6}>
                            <Form onSubmit={login}>
                                ...
                                <Button type="submit" variant="primary" className="text-dark my-4">Log In</Button><br />
                                <Link to="/registation" className="text-danger my-5">Not a member? Click Here for SING UP</Link>
                                <h2 className="mt-2 text-danger">------- OR -------</h2>
                                <div>
                                    <Button className="mt-2 bg-primary border-0 text-dark" onClick={handleGoogleLogin}>{Google}</Button>
                                </div>
                            </Form>
                        </Col>
                    </Row>
