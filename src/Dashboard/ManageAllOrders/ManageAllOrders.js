...
const ManageAllOrders = () => {
    ...
    useEffect(() => {
        fetch('https://mysterious-anchorage-89196.herokuapp.com/manageorders')
            .then((res) => res.json())
    ...
    const handleDelete = (id) => {
        ...
        if (proced) {
            const url = `https://mysterious-anchorage-89196.herokuapp.com/allorderdelete/${id}`;
    ...
    const handleUpdate = (id) => {
        const url = `https://mysterious-anchorage-89196.herokuapp.com/placeorders/${id}`;
        fetch(url, {
            method: 'PUT',
            headers: {
